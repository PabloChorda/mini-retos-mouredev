...
El jugador con el resultado más alto en su turno le quita puntos al otro jugador, igual a la diferencia entre los totales de los dados.
Si hay empate, no se pierde ni se gana puntos en ese turno.
